...
function defineChecklists(checklists2) {
  return checklists2;
}
...
var checklists = defineChecklists([releaseKit, labelSync, nmr, codeQuality, repoSetup]);
function fileExists(relativePath) {
  return existsSync2(join(process.cwd(), relativePath));
}
function readFile(relativePath) {
  const fullPath = join(process.cwd(), relativePath);
  if (!existsSync2(fullPath)) return void 0;
