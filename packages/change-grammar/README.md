...
- **Taxonomy:** `CANONICAL_TAXONOMY` is the shared work-type taxonomy, typed as `CanonicalTaxonomy`. Every function that takes a taxonomy accepts it, or any object of the narrower `Taxonomy` shape.
